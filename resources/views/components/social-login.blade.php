  <div class="flex flex-col justify-center md:flex-row gap-4 w-full">
      <a href="{{ route('auth.google.redirect') }}" class="btn bg-white text-black border-[#e5e5e5] ">
      ...
      <a href="{{ route('auth.facebook.redirect') }}" class="btn bg-[#1A77F2] text-white border-[#005fd8]">
